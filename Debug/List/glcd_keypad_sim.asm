...
_0x0:
	...
	.DB  0x0,0x47,0x50,0x52,0x53,0x20,0x49,0x6E
...
; 0000 0206         if (sms_received) {
	SBRC R2,1
; 0000 0207             handle_sms();        // ECE?? ?? header_buffer ? content_buffer ?C ??C?O ???I?I
	RCALL _handle_sms
; 0000 0208         }
; 0000 0209 
; 0000 020A         if (millis() - last_time > 50000) {
	RCALL _millis
	MOVW R26,R30
	MOVW R24,R22
	LDS  R30,_last_time
